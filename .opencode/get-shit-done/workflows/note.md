...
- **Global scope**: `/Users/user1/Projects/master-opencode/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/user1/Projects/master-opencode/.opencode/notes/`)
...
2. Glob `/Users/user1/Projects/master-opencode/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/Users/user1/Projects/master-opencode/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/user1/Projects/master-opencode/.opencode/notes/` — works in any directory
