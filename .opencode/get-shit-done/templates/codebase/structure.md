...
- Usage: Reference from command with `@/Users/user1/Projects/master-opencode/.opencode/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/user1/Projects/master-opencode/.opencode/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/user1/Projects/master-opencode/.opencode/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
