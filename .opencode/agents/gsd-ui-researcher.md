...
Use template from `/Users/user1/Projects/master-opencode/.opencode/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/user1/Projects/master-opencode/.opencode/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/user1/Projects/master-opencode/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
